...
grub_video_color_t
grub_video_map_color(UINT32 color_name)
{
	if (!grub_video_adapter_active)
		return 0;
...
grub_video_color_t
grub_video_map_rgb(UINT8 red, UINT8 green, UINT8 blue)
{
	if (!grub_video_adapter_active)
		return 0;
...
grub_video_color_t
grub_video_map_rgba(UINT8 red, UINT8 green, UINT8 blue,
	UINT8 alpha)
{
	if (!grub_video_adapter_active)
		return 0;
...
grub_err_t
grub_video_unmap_color(grub_video_color_t color, UINT8 *red,
