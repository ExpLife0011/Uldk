...
typedef UINT32 grub_video_color_t;
...
{
	UINT8 r; /* Red color value (0-255).  */
	UINT8 g; /* Green color value (0-255).  */
	UINT8 b; /* Blue color value (0-255).  */
	UINT8 a; /* Reserved bits value (0-255).  */
};
...
struct grub_video_edid_info
{
	...
	UINT8 max_horizontal_image_size;
	UINT8 max_vertical_image_size;
	UINT8 display_gamma;
...
#define GRUB_VIDEO_EDID_FEATURE_PREFERRED_TIMING_MODE	(1 << 1)
	...
	struct {
		...
		UINT8 horizontal_active_lo;
		UINT8 horizontal_blanking_lo;
		UINT8 horizontal_hi;
		UINT8 vertical_active_lo;
		UINT8 vertical_blanking_lo;
		UINT8 vertical_hi;
		UINT8 horizontal_sync_offset_lo;
		UINT8 horizontal_sync_pulse_width_lo;
		UINT8 vertical_sync_lo;
		UINT8 sync_hi;
		UINT8 horizontal_image_size_lo;
		UINT8 vertical_image_size_lo;
		UINT8 image_size_hi;
...
struct grub_video_adapter
{
	...
	grub_video_color_t(*map_color) (UINT32 color_name);

	grub_video_color_t(*map_rgb) (UINT8 red, UINT8 green,
		UINT8 blue);

	grub_video_color_t(*map_rgba) (UINT8 red, UINT8 green,
...
grub_video_color_t EXPORT_FUNC(grub_video_map_color) (UINT32 color_name);

grub_video_color_t EXPORT_FUNC(grub_video_map_rgb) (UINT8 red,
	UINT8 green,
	UINT8 blue);

grub_video_color_t EXPORT_FUNC(grub_video_map_rgba) (UINT8 red,
	UINT8 green,
	UINT8 blue,
	UINT8 alpha);
...
grub_video_rgba_color_rgb(UINT8 r, UINT8 g, UINT8 b)
{
